...
const translations = {
    ua: {
        ...
        game_info: {
            ...
            cta_demo: "Демо бою",
            how_to_get: {
                title: "Як отримати NFT",
                subtitle: "Дізнайтесь усі способи отримання унікальних NFT-бійців та аксесуарів у NFT Battle Arena",
                free_nft_title: "Безкоштовний стартовий NFT",
                free_nft_desc: "Кожен новий гравець отримує свого першого NFT-бійця абсолютно безкоштовно через Airdrop систему.",
                purchase_title: "Покупка за Telegram Stars",
                purchase_desc: "Додаткові унікальні NFT та аксесуари можна придбати за Telegram Stars у внутрішньому магазині.",
                rewards_title: "Нагороди за досягнення",
                rewards_desc: "Отримуйте рідкісні NFT за участь у турнірах, досягнення високих рейтингів та виконання спеціальних завдань."
            },
            rules: {
                title: "Правила гри",
                subtitle: "Ознайомтесь з основними правилами та механікою гри для успішного старту",
                start_title: "Початок гри і перший NFT",
                start_item_1: "При першому вході гравець отримує безкоштовного базового NFT-бійця",
                start_item_2: "Цей воїн потрібен для початкових боїв проти бота та отримання перших BP-поінтів",
                start_item_3: "Стартовий NFT має базові характеристики, які можна покращити",
                bp_title: "Система BP-поінтів",
                bp_item_1: "BP-поінти нараховуються за перемогу в боях проти бота",
                bp_item_2: "Гравець може отримувати безкоштовні BP-поінти щодня – раз на 24 години",
                bp_item_3: "BP-поінти можна конвертувати в реальні нагороди через спеціальні аксесуари",
                battle_title: "Бойова система",
                battle_item_1: "Кожен боєць має 2500 HP (гравець) та 2400 HP (бот) для балансу",
                battle_item_2: "Три типи дій: атака, захист, спеціальний удар",
                battle_item_3: "Перемога приносить BP-поінти і досвід для покращення воїна",
                economy_title: "Економіка гри",
                economy_item_1: "Всі NFT та аксесуари купуються виключно за Telegram Stars",
                economy_item_2: "BP-поінти НЕ витрачаються на покупки - тільки на вивід через аксесуари",
                economy_item_3: "Прозора економіка - всі ціни та можливості виводу відображаються чесно"
            }
        },
        roadmap: {
